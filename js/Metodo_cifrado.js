...
function cifrar(mensaje) {
    ...
    escribirComoMaquina(mensaje_cifrado, respuestaContainer, true); // Para el cifrado
...
if (clave < 26 && clave > 0) {
    ...
    var respuestaContainer = document.getElementById("respuesta-container");
    respuestaContainer.textContent = ""; 
    escribirComoMaquina(mensaje_cifrado, respuestaContainer, false); // Para el cifrado
